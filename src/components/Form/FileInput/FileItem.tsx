...
const fileItem = tv({
  ...
  variants: {
    state: {
      ...
      completed: {
        container: "border-violet-500 dark:border-violet-400/20",
      },
      error: {
        container:
          "bg-error-25 border-error-300 dark:bg-error-500/5 dark:border-error-500/30",
        icon: "border-error-50 bg-error-300 text-error-600 bg-white dark:bg-error-500/5 dark:border-error-500/30 dark:text-error-400",
        deleteButton:
