...
export function TabItem({ value, title, isSelected = false }: TabItemProps) {
  return (
    <Tabs.Trigger
      value={value}
      className="relative group px-1 pb-4 text-sm font-medium text-zinc-500 dark:hover:text-violet-300 dark:data-[state=active]:text-violet-300 hover:text-violet-700 data-[state=active]:text-violet-700 outline-none"
    >
